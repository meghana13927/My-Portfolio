          ...
          <div className="grid items-center gap-10 lg:grid-cols-[1fr_0.7fr]">
            <div>
              ...
              <div className="mt-8 space-y-4">
                {highlights.map((item) => (
                  <div key={item} className="flex items-start gap-4 rounded-2xl bg-gradient-to-r from-orange-50 to-white p-4">
                    <FaFileAlt className="mt-1 text-sky-600" />
            ...
            <div className="rounded-[2rem] bg-gradient-to-br from-sky-50 via-white to-orange-50 p-8">
