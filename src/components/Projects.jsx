    ...
    <motion.section id="projects" className="section-shell px-6 py-28 lg:px-8" initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true }}>
      <div className="mx-auto max-w-7xl">
        <div className="section-heading">
          ...
          <p>
            The project section now behaves more like a product showcase: one featured case study up front, followed by supporting builds with visuals and direct links.
          </p>
        </div>
        ...
        <div className="space-y-8 [perspective:2000px]">
          ...
          <div className="grid gap-8 md:grid-cols-2 xl:grid-cols-2 [perspective:1800px]">
